...
func TestSummarizeMessages_BelowKeepRecent(t *testing.T) {
	...
	result, _, err := summarizeMessages(context.Background(), req, &ResolvedUpstream{}, 6, silentLogger(), nil)
	if err != nil {
...
func TestSummarizeMessages_WithMockSummarizer(t *testing.T) {
	...
	result, _, err := summarizeMessages(context.Background(), req, summarizer, 4, silentLogger(), nil)
	if err != nil {
...
func TestSummarizeMessages_DoesNotSplitToolPair(t *testing.T) {
	...
	result, _, err := summarizeMessages(context.Background(), req, summarizer, 2, silentLogger(), nil)
	if err != nil {
		t.Fatalf("summarizeMessages: %v", err)
	}
